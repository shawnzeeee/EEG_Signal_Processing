...
//-----------------------------------------------------------	--------------------------
#define HOST_IP "192.168.1.64" // Default address is the loopback address, else the ip of the computer running GDS.
#define HOST_PORT 50223     // The default port of GDS is 50223.
#define LOCAL_IP "192.168.1.86"// Default address is the loppback address, else the ip of the client machine.
