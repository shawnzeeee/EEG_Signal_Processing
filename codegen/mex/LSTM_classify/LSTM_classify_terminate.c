 ...
 *
 * LSTM_classify_terminate.c
 *
 * Code generation for function 'LSTM_classify_terminate'
 *
 */
...
void LSTM_classify_atexit(void)
{
...
void LSTM_classify_terminate(void)
{
  emlrtDestroyRootTLS(&emlrtRootTLSGlobal);
}

/* End of code generation (LSTM_classify_terminate.c) */
